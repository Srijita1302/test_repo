...
const lineChartData = [
  [
    ...
    "Potentially Non-Compliant Policy",
    "Violation",
  ],
...
const lineChartOptions = {
  ...
  hAxis: {
    ...
    format: "MMM-yy",
    gridlines: { count: 3 },
    ticks: [new Date(2023, 3, 1), new Date(2023, 4, 1), new Date(2023, 5, 1)],
  },
  series: {
...
function DashboardChart() {
  ...
  const taskStatusSummaryData = {
    labels: chartDataSource.slice(1).map((row) => row[0]), // Extract labels
    // labels: ["Overdue", "Open", "Completed"],
    datasets: [
      {
        // data: chartData[selectedOption],
        data: chartDataSource.slice(1).map((row) => row[1]), // Extract data
    ...
    <div className="row m-3">
      ...
      <div className="col-6 ">
        ...
        >
          <material.Typography
            ...
            sx={{ textAlign: "left", paddingLeft: 2, width: "100%" }}
          >
            Violations Summary
          </material.Typography>
      ...
      <div className="col-6 ">
        ...
        >
          ...
          <Doughnut
            data={taskStatusSummaryData}
            options={taskStatusSummaryOptions}
          />
        </material.Card>
      </div>
      <div className="col-6 ">
      ...
      <div className="col-6 ">
        ...
        >
          <Doughnut
            data={dataChartAcknowledgement}
            options={chartOptionsAcknowledgement}
          />
          <div
            style={{
              marginTop: "-250px",
